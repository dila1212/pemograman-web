        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">          
                        <div class="mb-3">
                            <label for="nama_pemasok" class="form-label">Nama_pemasok</label>
                            <input type="text" class="form-control" name="nama_pemasok"  placeholder="Masukan Nama_pemasok" >
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                    ...
                                    <form action="modul/pemasok/proses.php?aksi=edit&id=<?= $row_pemasok['id_pemasok']; ?>" method="post">
                                        <label class="form-table" for="nama_pemasok">Nama_Pemasok</label>
